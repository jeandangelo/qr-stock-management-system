...
app.put('/api/items/:id', async (req, res) => {
  ...
  for (const key in updates) {
    if (updates.hasOwnProperty(key)) {
      let dbColumn = key;
      switch (key) {
        case 'stock': dbColumn = 'stock'; break; 
        case 'name': dbColumn = 'nombre'; break; 
        case 'description': dbColumn = 'descripcion'; break; 
        case 'code': dbColumn = 'codigo_barra'; break; 
        case 'value': dbColumn = 'valor_unitario'; break; 
        case 'category': dbColumn = 'categoria'; break; 
        case 'minStock': dbColumn = 'min_stock'; break; 
        case 'location': dbColumn = 'ubicacion_principal'; break; 
        case 'supplier': dbColumn = 'proveedor'; break; 
        case 'unidad_medida': dbColumn = 'unidad_medida'; break; 
        default: break; 
      }
...
// Ruta de verificación de salud para Render.com
app.get('/', (req, res) => {
  res.status(200).send('WMS Pro Backend is running!');
});
